      ...
      <section className="max-w-[85rem] mx-auto p-4 md:px-4 pt-8 py-12 md:pt-12 md:pb-16 lg:pb-20 lg:pt-10 space-y-2 lg:space-y-4 scroll-mt-12">
        <div className="space-y-4 lg:space-y-10 bg-colors-mint p-4 lg:px-8 lg:py-4 rounded-[2rem]">
          <div className="flex items-center justify-between">
            <h3 className="text-h3 font-bold font-estedad">محصولات پرفروش</h3>
            <a
              href="#"
              ...
              >
                ...
                <div className="space-y-3 lg:space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <h4 className="text-h4 font-lora font-semibold text-colors-forest">
                      {product.price}
                    </h4>
                  </div>
                </div>
